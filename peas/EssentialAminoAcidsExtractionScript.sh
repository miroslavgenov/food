...
foodName=$1
targetLocationToBeFiltered=$(echo ${currentWorkingDirectory}/${foodName}"/amino-acids/EssentialAminoAcids.txt")
# targetLocationToBeFiltered="./amino-acids/EssentialAminoAcids.txt"
